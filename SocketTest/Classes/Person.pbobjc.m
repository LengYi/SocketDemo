  ...
  if (!descriptor) {
    static GPBMessageFieldDescription fields[] = {
      ...
      },
      {
        ...
        .number = AppContextMessage_FieldNumber_UsersArray,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(AppContextMessage__storage_, usersArray),
      ...
      },
      {
        .name = "dic",
        .dataTypeSpecific.className = NULL,
        .number = AppContextMessage_FieldNumber_Dic,
        .hasIndex = GPBNoHasBit,
        .offset = (uint32_t)offsetof(AppContextMessage__storage_, dic),
